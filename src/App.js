...
class App extends Component {
  ...
  renderMap = () => {
    loadScript(
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyA85Gv4dH0smEaGALhiaq_rjGUqwdun0k8&callback=initMap"
    );
  ...
  getVenues = () => {
    ...
    const parameters = {
      client_id: "K1QJTWCX1SYVIYIMZCJMZNXNHMVQWDDRMV405IDWRPV3MFQI",
      client_secret: "5R04STD0RSJSUTREWPTDX40RFQ1TYUIGKPXG1W42O2VTG3DK",
      query: "food",
      near: "Syracuse, NY",
      v: "20182309"
    };
